...
public class Interpretator {
     ...
     * Результат: 1. Размещение на СО ссылки на объект типа reference
     *            2. Размешение на osOut ссылки на объект типа reference
     * Механика: В нормальном режиме получает в качестве аргуменов адрес
     *           значения в CP с определение создаваемого объекта и
     *           TID, в котором необходимо создать эземлпяр.
     ...
     * @param pointer
     */
    public void INTERPRETATOR_Exec_New(int cpPointer, byte threadPointer) {
        /*
